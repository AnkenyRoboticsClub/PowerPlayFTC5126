...
public class MecanumDrivingSample extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        MecanumDrive drive = new MecanumDrive(
            new Motor(hardwareMap, "Motor3", Motor.GoBILDA.RPM_435),
            new Motor(hardwareMap, "Motor0", Motor.GoBILDA.RPM_435),
            new Motor(hardwareMap, "Motor2", Motor.GoBILDA.RPM_435),
            new Motor(hardwareMap, "Motor1", Motor.GoBILDA.RPM_435)
        );
